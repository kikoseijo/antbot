                   ...
                   <div class="overflow-y-auto py-4 px-3 bg-gray-50 sm:rounded-lg dark:bg-gray-800">
                      <ul class="space-y-2">
                          @forelse ($exchanges as $exchange)
                              <li>
                                  <a href="{{ route('exchanges.positions', $exchange) }}" class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
