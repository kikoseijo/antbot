            ...
            <div>
                ...
                <div class="flex mt-2">
                    <div class="flex items-center mr-4">
                        <input id="is_testnet_1" type="radio" value="1"  wire:model.defer="exchange.is_testnet" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                    ...
                    <div class="flex items-center mr-4 ml-4">
                        <input id="is_testnet_2" type="radio" value="0"  wire:model.defer="exchange.is_testnet" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
