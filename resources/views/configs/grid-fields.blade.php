...
<div class="grid grid-cols-3 grid-flow-col gap-2 mb-3">
    <div class="mb-3">
        ...
        <x-text-input id="auto_unstuck_ema_dist" type="number" step="any" class="mt-1 block w-full" wire:model.defer="{{$grid_mode}}.auto_unstuck_ema_dist" required/>
    ...
    <div class="mb-3">
        ...
        <x-text-input id="auto_unstuck_wallet_exposure_threshold" type="number" step="any" class="mt-1 block w-full" wire:model.defer="{{$grid_mode}}.auto_unstuck_wallet_exposure_threshold" required/>
...
<div class="grid grid-cols-4 grid-flow-col gap-2 mb-3">
    <div>
        ...
        <x-text-input id="initial_qty_pct" type="number" step="any" class="mt-1 block w-full" wire:model.defer="{{$grid_mode}}.initial_qty_pct" required/>
    ...
    <div>
        ...
        <x-text-input id="initial_eprice_ema_dist" type="number" step="any" class="mt-1 block w-full" wire:model.defer="{{$grid_mode}}.initial_eprice_ema_dist" required/>
    ...
    <div>
        ...
        <x-text-input id="ema_span_0" type="number" step="any" class="mt-1 block w-full" wire:model.defer="{{$grid_mode}}.ema_span_0" required/>
        <x-input-error class="mt-2" :messages="$errors->get($grid_mode . '.ema_span_0')" />
    </div>
    <div>
        <x-input-label for="ema_span_1" :value="__('EMA span 1')" />
        <x-text-input id="ema_span_1" type="number" step="any" class="mt-1 block w-full" wire:model.defer="{{$grid_mode}}.ema_span_1" required/>
...
<div class="grid grid-cols-3 grid-flow-col gap-2 mb-3">
    <div>
        ...
        <x-text-input id="markup_range" type="number" step="any" class="mt-1 block w-full" wire:model.defer="{{$grid_mode}}.markup_range" required/>
        <x-input-error class="mt-2" :messages="$errors->get($grid_mode . '.markup_range')" />
    </div>
    <div>
        <x-input-label for="min_markup" :value="__('Min markup')" />
        <x-text-input id="min_markup" type="number" step="any" class="mt-1 block w-full" wire:model.defer="{{$grid_mode}}.min_markup" required/>
    ...
    <div>
        ...
        <x-text-input id="n_close_orders" type="number" step="any" class="mt-1 block w-full" wire:model.defer="{{$grid_mode}}.n_close_orders" required/>
...
@if ($grid->type == 'recursive')
    ...
    <div class="grid grid-cols-3 grid-flow-col gap-2 mb-3">
        <div>
            ...
            <x-text-input id="rentry_pprice_dist_wallet_exposure_weighting" type="number" step="any" class="mt-1 block w-full" wire:model.defer="{{$grid_mode}}.rentry_pprice_dist_wallet_exposure_weighting" required/>
        ...
        <div>
            ...
            <x-text-input id="rentry_pprice_dist" type="number" step="any" class="mt-1 block w-full" wire:model.defer="{{$grid_mode}}.rentry_pprice_dist" required/>
        ...
        <div>
            ...
            <x-text-input id="ddown_factor" type="number" step="any" class="mt-1 block w-full" wire:model.defer="{{$grid_mode}}.ddown_factor" required/>
...
@elseif ($grid->type == 'static')
    ...
    <div class="grid grid-cols-5 grid-flow-col gap-2 mb-3">
        <div>
            ...
            <x-text-input id="eprice_exp_base" type="number" step="any" class="mt-1 block w-full" wire:model.defer="{{$grid_mode}}.eprice_exp_base" required/>
        ...
        <div>
            ...
            <x-text-input id="eprice_pprice_diff" type="number" step="any" class="mt-1 block w-full" wire:model.defer="{{$grid_mode}}.eprice_pprice_diff" required/>
            <x-input-error class="mt-2" :messages="$errors->get($grid_mode . '.eprice_pprice_diff')" />
        </div>
        <div>
            <x-input-label for="grid_span" :value="__('grid_span')" />
            <x-text-input id="grid_span" type="number" step="any" class="mt-1 block w-full" wire:model.defer="{{$grid_mode}}.grid_span" required/>
        ...
        <div>
            ...
            <x-text-input id="secondary_allocation" type="number" step="any" class="mt-1 block w-full" wire:model.defer="{{$grid_mode}}.secondary_allocation" required/>
        ...
        <div>
            ...
            <x-text-input id="secondary_pprice_diff" type="number" step="any" class="mt-1 block w-full" wire:model.defer="{{$grid_mode}}.secondary_pprice_diff" required/>
...
@else
    ...
    <div class="grid grid-cols-5 grid-flow-col gap-2 mb-3">
        <div>
            ...
            <x-text-input id="eqty_exp_base" type="number" step="any" class="mt-1 block w-full" wire:model.defer="{{$grid_mode}}.eqty_exp_base" required/>
